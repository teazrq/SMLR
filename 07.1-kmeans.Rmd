...
Let's first load and plot an image of my kids Leo and Lia (all copy rights reserved). 

```{r fig.dim=c(4, 5), out.width = "35%"}
    library(jpeg)
    img<-readJPEG("data/leolia.jpg")
...
```{r, fig.dim= c(18, 5), out.width = "100%", echo = FALSE, warning=FALSE}
  par(mfrow=c(1, 5))
  par(mar=rep(0.1, 4))
