...
We can calculate different model selection criteria with the best models of each size. The model fitting result already produces the $C_p$ and BIC results. Our calculation will match their $C_p$ statistics exactly. For the BIC, the difference is a constant regardless of the model size. Hence this different will not affect the model selection result.
