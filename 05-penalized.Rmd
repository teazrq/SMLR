...
Ridge regression was proposed by @hoerl1970ridge. The essential idea is very simple, we add a ridge on the diagonal elements of $\bX^\T \bX$ so that it becomes invertible. Hence, the solution of the parameters is 
...
The variance of both $\beta_1$ and $\beta_2$ are quite large. This can also be interpreted through an optimization point of view. The objective function for an OLS estimator is demonstrated in the following.
